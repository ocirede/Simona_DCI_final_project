...
export default function NavBarHomepage() {
  ...
  return (
    <nav className=" h-20 z-50 p-3  bg-white-400 flex flex-wrap items-center justify-between md:flex-row   relative rounded-lg shadow-lg border border-gray">
      ...
      <div className={`${isOpen ? "flex" : "hidden"} md:flex flex-col md:flex-row w-full md:items-center md:justify-end md:w-auto absolute md:relative top-full md:top-0 left-0 bg-gray-100 md:bg-transparent w-screen md:w-auto z-40 p-4 md:p-0 rounded-lg md:rounded-none shadow-lg md:shadow-none border border-gray md:border-none`}>
