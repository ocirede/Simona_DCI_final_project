  ...
  return (
    <section className="flex justify-center items-center  h-[130px] mt-2">
      ...
      <div className="absolute top-0 -left-8  sm:left-12 md:left-28 lg:left-56 ">
        <a href={contactMail}>
        <button className=" flex items-center justify-center w-[100px] h-[40px] absolute left-12 top-[460px] rounded-xl bg-slate-500">
          <span className="text-white">Contact me</span>
        </button>
        </a>
      </div>
      <label>
        <div className="bg-slate-500 w-28 h-28 rounded-full cursor-pointer absolute top-[440px] transform -translate-x-1/2 z-20">
      ...
      <div className="absolute top-0 -right-8  sm:right-12 md:right-28  lg:right-56">
        <button onClick={onClick} className=" flex items-center justify-center w-[100px] h-[40px] absolute right-12 top-[460px] rounded-xl bg-slate-500">
