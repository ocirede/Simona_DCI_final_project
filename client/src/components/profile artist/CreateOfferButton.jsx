    ...
    <>
      <div>
        <button
          ...
          className="bg-retroBlue hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-[30px]"
        >
          Create Offer
        </button>
            ...
            <div className="bg-white p-8 shadow-lg rounded-lg border border-gray-200 w-full h-full md:w-1/4 md:h-auto">
              ...
              >
                <input
                  ...
                  required
                  className="w-full p-2 mb-4 border-2  border-gray-500 rounded bg-white"
                />
                <input
                  type="text"
                  name="description"
