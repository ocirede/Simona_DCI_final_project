...
return (
    <>
      ...
      <div className="flex w-full border border-b-8 border-black rounded-2xl shadow-lg overflow-hidden  md:w-1/2 md:max-h-[435px]">
      ...
      <div className="flex-1 overflow-auto pt-4 bg-white three">
        <Container>
          <MotionSlider>
