...
export default function OffersSection() {
  ...
  return (
    <>
    <div className="flex items-center justify-center p-4 border-b-2 bg-red-100 cursor-pointer" onClick={() => setShowOffersSection(!showOffersSection)}>offersSection</div>
