...
function ProfileImgBgSection({ user }) {
    ...
    return (
        <div className="relative">
            <div className={`bg-${user.profileBackground ? 'cover' : 'white'} lg:mr-[10px] lg:ml-[10px] h-[200px] rounded-bl-[30px] rounded-br-[30px] relative  border-b-black border-l-black border-r-black`} style={user.profileBackground ? { backgroundImage: `url(${user.profileBackground})` } : null}>
                <input
                    ref={inputFileRef}
                    type="file"
