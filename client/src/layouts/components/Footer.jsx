...
export default function Footer() {
  return (
    <footer className="bg-cobaltBlue relative m-2 rounded-[30px] border-1 border-black border md:h-[450px]">
      <div className="flex flex-col md:flex-row md:justify-between">
        ...
        <div className="flex flex-col">
          <div className="lg:w-1/3 flex items-center justify-center pt-6 bg-[url('/lines_two.svg')] bg-cover bg-center border-t border-black border-b bg-white rounded-tr-[30px]">
                  <img src="/footer_shape.svg" alt="lines" className="w-[290px] md:w-[310px] pb-6"></img>
          </div>
          <div className="flex justify-between items-start md:m-0 bg-white rounded-br-[30px] rounded-bl-[30px] md:rounded-bl-none gap-2 pt-6 pr-6 pl-6 pb-8">
            ...
            <div className="mb-4 md:mb-0 items-center gap-2 text-[20px] md:mt-[126px]">
