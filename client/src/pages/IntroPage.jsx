    ...
    <div className="">
        ...
        <div className="m-10">
          ...
          <div className="mt-8">
            <p className="pb-4">
              ...
              <span className="uppercase text-[25px]">right</span> person?
            </p>
            <p>
              With Simona you don't have to feel lost anymore, start searching
              for your next gig, exhibition or a business partner{" "}
              <span className="uppercase text-[25px]">now</span> within our cool
              scene and connect with various funky folks out there!
            </p>
            <button className="bg-gray-300 rounded-lg p-2 mt-4">Join us</button>
          </div>
        </div>
        <div className="lg:m-10 lg:mr-40">
          <h2 className="uppercase text-[38px] pb-5 text-center">
            Our groovy Artists
          </h2>
      ...
      <div className="bg-gray-600 mt-4 mb-4 pb-14 lg:flex lg:justify-center">
        <div className="lg:order-2 lg:mr-40">
          <h3 className="text-[52px] text-center pt-10 lg:pl-40 lg:text-right">
            What do we do?
          </h3>
          <p className="text-center pt-10 pb-10 lg:pl-20 lg:text-right">
            Add here description
          </p>
        </div>
        <div className="lg:order-1">
          <h2 className="uppercase text-[38px] mb-5 text-center">
